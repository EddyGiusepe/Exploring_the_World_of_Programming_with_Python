...
" Fornecerei a você um documento e você fonecerá um resumo de seis parágrafos desse documento. Cada parágrafo deve conter, obrigatoriamente, 1500 palavras como mínimo."
...
" Verifique se o Editor de Conteúdo considerou, obrigatoriamente, 200 palavras em cada parágrafo.",
        ),
        MessagesPlaceholder(variable_name="text"),
    ]
)
...
print(f"Tempo de inferência: {tempo_inferencia} segundos")
