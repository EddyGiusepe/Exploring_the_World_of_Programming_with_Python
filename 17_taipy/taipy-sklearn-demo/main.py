"""
Link de estudo --> https://blog.dailydoseofds.com/p/taipy-scikit-learn-app

Taiypy --> https://github.com/Avaiga/taipy?tab=readme-ov-file
"""
import taipy as tp
...
if __name__ == "__main__":
    ...
    gui.run(dark_mode=False, port=3559, title="Aplicativo de demonstração Taipy Scikit")
